...
export default function Header({ isLanding }: { isLanding?: boolean }) {
  ...
  return (
    <header className="mb-6 w-full text-sm not-has-[nav]:hidden lg:max-w-7xl mx-auto flex justify-between gap-2 px-6 py-2 lg:px-2 absolute z-100 left-0 right-0">
      <Link
        href={'/'}
      >
